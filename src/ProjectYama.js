            ...
            <div className="project-yama-container">
              ...
              <div className="py--process-container">
                ...
                <div className="py--process-user-needs">
                  ...
                  <div className="py--process-item">
                    ...
                    <p>
                      ...
                      <span className="mg--semibold">career advancement</span>,{' '}
                      <span className="mg--semibold">mentorship discovery</span>
                      , and <span className="mg--semibold">inspiration</span>
                    </p>
                  </div>
                </div>
                  ...
                  <div className="py--challenge-1-two-by-two">
                    <div className="py--challenge-1-left">
                      ...
                      <ul>
                        ...
                        <li>
                          Leverages issues as post submissions, commenting on a
                          post/issue, image uploading.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="py--challenge-1">
                  ...
                  <div className="py--challenge-1-two-by-two">
                    ...
                    <div className="py--challenge-1-right">
                      <h5>Box</h5>
                      <p>
                        The tool is used by designers, researchers, and offering
                        managers to sort assets, resources and deliverables.
                        Although the tool serves as a great place to house your
                        sketch files and presentation decks, its interface isnt
                        set up for effectively viewing visual work, let alone
                        contextual support.
                      </p>
                      <p className="mg--semibold">
                  ...
                  <div className="py--challenge-1-two-by-two py--section-end">
                    <div className="py--challenge-1-left">
                      ...
                      <p>
                        ...
                        developers work together to build production-level code.
                        In GitHub Enterprise, teams gauge in important product
                        design critiques and is ultimately shaping the product
                        outcomes. However, This discussions and design shares
                ...
                <div className="py--challege-3">
                  ...
                  <p>
                    After understanding how we could differentiate our tool from
                    the others, we developed unique value propositions for the
                    platform that would scope us during development, and build
                    habit-forming experience that our designers could get
                    behind.
                  </p>
                ...
                <div className="py--user-flows py--section-end">
                  ...
                  <p>
                    ...
                    wireframes for those pages. We then held in person feedback
                    sessions allowing users to provide feedback on the frames
                    and flow.
                  </p>
                </div>
                ...
                <div className="py--section-end">
                  ...
                  <p>
                    ...
                    opportunities for designers coming to the platform to engage
                    in the way they wanted to as quickly as possible. Those
                    scenarios included:
                  </p>
                  <ul className="py--work-gallery-solution-list">
                    <li>
                      A designer looking for inspiration on a specific design
                      element, component, or pattern they are currently working
                      on.
                    </li>
                    <li>
                ...
                <div className="py--upload-experience py--section-end">
                  ...
                  <div className="py--challenge-1-two-by-two py--upload-collaborators-container">
                    <div className="py--challenge-1-left">
                      ...
                      <p>
                        <span className="mg--semibold">WIP, SHIP, FLIP</span> --
                        designating different work types, allowing the designs
                        to be seen for where they are in the process.
                      </p>
                    </div>
                    <div className="py--challenge-1-right">
                      <img
                ...
                <div className="py--portfolio-experience">
                  <div className="py--challenge-1-two-by-two py--upload-collaborators-container">
                    <div className="py--challenge-1-left">
                      ...
                      <p>
                        ...
                        environment that showcases their work and invites others
                        to dive deeper into their projects.
                      </p>
                      <p>
                        Metaphorical, we wanted the Portfolio experience to feel
                        like your bookcase at home - it had to feel like a
                        living, constantly updated mess of cleanliness.
                      </p>
                    </div>
                    <div className="py--challenge-1-right">
                      <img
                  ...
                  <p>
                    ...
                    visual emphasis on the card your considering, but having the
                    hover state increase the white border.
                  </p>
                  <img
                    src={profileEmpty}
                  ...
                  />
                  <p>
                    Lastly, we wanted to share the empty state of the workspace
                    in the portfolio. An illustration was created that lent
                    itself to the call to action to get the designer to stop
                    what they were doing to take the time to document their
                    process.
                  </p>
