...
class ProjectYama extends Component {
	...
	render() {
		const { showPageContent, value } = this.state;
		return (
						...
						<div className="project-yama-container">
							...
							<div className="py--about-container">
								<div className="py--about-label">
									<h5>Objective</h5>
									<p>Design and develop a platform that allows IBM designers to share their design work internally.</p>
								</div>
								<div className="py--about-label">
									<h5>Roles</h5>
...
className="py--business-need-img" />
								...
								<div className="py--process-user-needs">
									...
									<div className="py--process-item">
										...
										<p>
											IBM designers need a place to document and curate their process and outcomes, to be used for{' '}
											<span className="mg--semibold">career advancement</span>, <span className="mg--semibold">mentorship discovery</span>, and{' '}
								...
								<div className="py--challenge-1 py--section-end">
									...
									<p>
										After development discussions, it was clear that we would need many resources that were not in our budget. File storage, individual
										profiles, and commenting called for a custom database, which we could not get approval for.
									</p>
...
className="py--challenge-1-right-img" />
								...
								<div className="py--challenge-1">
									...
									<p>
										...
										before design/development started. I concentrated on the main tools used for sharing working, and conducted research on where we could
...
className="py--challenge-1-right-img" />
									...
									<div className="py--challenge-1-two-by-two">
										<div className="py--challenge-1-left">
											<h5>Slack</h5>
											<p>
												The tool connects remote and co-located teams, and now serves as the place for communication of over 100,000 IBMers. Although easy to
												chat on, design work sharing and critiquing in virtual impossible in the fleeting nature of slack channel discussions.
											</p>
											<p className="mg--semibold">Our tool should facilitate design critique that’s focused and documented.</p>
										</div>
										<div className="py--challenge-1-right">
											<h5>Box</h5>
											<p>
												The tool is used by designers, researchers, and offering managers to sort assets, resources and deliverables. Although the tool serves
												as a great place to house your sketch files and presentation decks, its interface isnt set up for effectively viewing visual work, let
												alone contextual support.
											</p>
											<p className="mg--semibold">Our tool should focus on visual discovery at speed, without the need to house assets in all formats. </p>
										</div>
									</div>
...
className="py--challenge-1-right-img" />
									...
									<div className="py--challenge-1-two-by-two py--section-end">
										<div className="py--challenge-1-left">
											...
											<p>
												The tool is used by teams, where designers and developers work together to build production-level code. In GitHub Enterprise, teams
												gauge in important product design critiques and is ultimately shaping the product outcomes. However, This discussions and design shares
												are done at a team level only.
											</p>
											<p className="mg--semibold">Our tool should opens up design solutions for the community to learn from and leverage.</p>
										</div>
										<div className="py--challenge-1-right">
											<h5>Checkpoint</h5>
											<p>
												The internal tool is used by designers and managers to assess product team goals and work output. The goals set in Checkpoint are
												ultimately measuring the designer&apos;s success in driving business outcomes, and can lead to career advancement. However, these goals
												are done in a text-based format, opposite of the visual outcomes designers come to.
											</p>
											<p className="mg--semibold">Our tool should support you justifying goals delivered on, and shows you walked the walk.</p>
										</div>
									</div>
								</div>
								...
								<div className="py--challege-3">
									...
									<div className="py--value-props">
										<h4 className="mg--light">
											Value proposition 1: <span className="mg--semibold">Findability & Discovery</span>
										</h4>
										<h4 className="mg--light">
											Value proposition 2: <span className="mg--semibold">Critique & Discussion</span>
										</h4>
										<h4 className="mg--light">
											Value proposition 3: <span className="mg--semibold">Documentation & Curation</span>
										</h4>
									</div>
								</div>
...
className="py--full-image" />
									<p>
										Our goal for the Work Gallery experience was to create opportunities for designers coming to the platform to engage in the way they wanted
										to as quickly as possible. Those scenarios included:
									</p>
									<ul className="py--work-gallery-solution-list">
										...
										<li>
											<span className="mg--semibold">Solution</span>: Increase tile size for easier investigation, more detailed hover information, and
											prominent search engine.
										</li>
										<li>A designer looking to engage in discussion by providing feedback to another designer&apos;s work</li>
										<li>
											<span className="mg--semibold">Solution</span>: Card corner icon soliciting feedback, helps distinguish the projects that are actively
...
className="py--full-image" />
									<div className="py--challenge-1-two-by-two py--upload-collaborators-container">
										<div className="py--challenge-1-left">
											...
											<p>Highlights:</p>
											<p>
												<span className="mg--semibold">Collaborators</span> -- being able to tag others in an upload, showcasing the true nture of collaborative
												work.
											</p>
											<p>
												<span className="mg--semibold">WIP, SHIP, FLIP</span> -- designating different work types, allowing the designs to be seen for where
												they are in the process.
											</p>
										</div>
										<div className="py--challenge-1-right">
											<img src={collaboratorsGif}
alt="Userflow"
className="py--challenge-1-right-img" />
										</div>
									</div>
...
className="py--full-image" />
									...
									<img src={profileOverlay}
alt="Upload screenshot"
className="py--full-image" />
									<p>
										The card design went through multiple iterations, but we kept it high level, just enough context to know if you should dive into the
										project. We also wanted to create visual emphasis on the card your considering, but having the hover state increase the white border.
									</p>
									<img src={profileEmpty}
...
className="py--full-image" />
									...
									<p className="mg--regular-italic">
										Page design by <span className="mg--semibold-italic">Evan Maeda</span>
									</p>
								</div>
							</div>
						</div>
						<div className="py--page-footer">
							<Link to="/"
className="nav-logo-link py--footer-link">
...
className="password-lock">
							...
							<div className="input-container">
								<form onSubmit={this.showYama}>
									...
									/>
									{value.length > 0 ? (
										<button className="show-yama-button"
type="submit">
