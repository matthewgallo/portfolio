	      ...
	      <div className="footer-container">
					...
					<a href="#" className="footer-logo-link">
						<svg className="mg--logo-footer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 400">
						  ...
						  <rect id="Rectangle" className="cls1 mg--logo-m-1" width="100" height="400"/>
						  <rect id="Rectangle-Copy" className="cls2 mg--logo-m-3" x="300" width="100" height="400"/>
						  <rect id="Rectangle-Copy-3" className="cls3 mg--logo-g-1" x="450" width="400" height="100"/>
						  <rect id="Rectangle-Copy-4" className="cls4 mg--logo-g-4" x="450" y="300" width="400" height="100"/>
						  <rect id="Rectangle-Copy-2" className="cls5 mg--logo-m-2" x="150" width="100" height="200"/>
