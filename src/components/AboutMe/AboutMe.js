	...
	return (
		<Styled.AboutContainer>
			...
			<TextStyles.ContentText medium
				...
				component library, or improving dev workflows, I’m all about making the front-end more efficient and usable for everyone.
			...
			<TextStyles.ContentText medium
				...
				<GradientLink external
					...
					Carbon for IBM Products library
				</GradientLink>
				, with React and web component support.
			</TextStyles.ContentText>
			{/*  */}
			<Bold size="expressive-heading-04"
				margin="1rem">
